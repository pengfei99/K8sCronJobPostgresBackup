...
class PostgresDbManager(DbManagerInterface):
    ...
    def restore_db(self, target_db_name, backup_file_path, backup_format: str) -> bool:
        ...
        # if the backup file is generated by using postgres custom format, we need to call restore_db_with_custom_format
        ...
        # if the backup file is generated by using plain text sql format, we need to call restore_db_with_sql_format
